   ...
   <header>
      <div id="header-nav">
         ...
         <div class="header-logo">
            <svg id="圖層_1" data-name="圖層 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 25">
               <defs>
            ...
            <!-- <img src="./img/header/header-logo.svg" alt="屏東-恆春民宿-森五七行館"> -->
         </div>
         <!-- 頁首-菜單 -->
         <div class="header-menu">
            <ul>
               <a href="/news"><li>訊 News</li></a>
               <a href="/"><li>宿 Rooms</li></a>
               <a href="booking"><li>訂 Booking</li></a>
               <a href="story"><li>源 Story</li></a>
               <a href="location"><li>行 Location</li></a>
            </ul>
         </div>
         <!-- 頁首-隱藏盒子 -->
         <div class="header-ham">
            <div class="header-btn"></div>
            <input type="checkbox" id="header-ham-box" hidden>
            <label for="header-ham-box" class="header-ham-line">
