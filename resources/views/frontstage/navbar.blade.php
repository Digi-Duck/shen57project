   ...
   <header>
      <div id="header-nav">
         ...
         <div class="header-menu">
            <ul>
               <a href="/news"><li @if(Route::is('news')) class="showline" @endif)>訊 News</li></a>
               <a href="/room5"><li @if(Route::is('room')) class="showline" @endif)>宿 Rooms</li></a>
               <a href="/booking"><li @if(Route::is('booking')) class="showline" @endif)>訂 Booking</li></a>
               <a href="/story"><li @if(Route::is('story')) class="showline" @endif)>源 Story</li></a>
               <a href="/location"><li @if(Route::is('location')) class="showline" @endif)>行 Location</li></a>
            </ul>
         </div>
         <!-- 頁首-隱藏盒子 -->
               ...
               <div id="header-hambox">
                  <div class="hambox-menu">
                     ...
                     <div class="hambox-logobox">
                        <a href="/home"><img src="{{asset('/img/header/header-hamlogo.svg')}}" class="hambox-logo" alt="屏東-恆春民宿-森五七行館"></a>
                     ...
                     <div class="hambox-infobox">
                        ...
                        <div class="hambox-info">
                           ...
                           <div class="hambox-info-left">
                              <ul>
                                 <a href="/news"><li>訊 News<span>˙</span></li></a>
                                 <a href="/room5"><li>宿 Rooms<span>˙</span></li></a>
                                 <a href="/booking"><li>訂 Booking<span>˙</span></li></a>
                                 <a href="/story"><li>源 Story<span>˙</span></li></a>
                                 <a href="/location"><li>行 Location<span>˙</span></li></a>
                              </ul>
                           </div>
                           <!-- hambox-關於 -->
                              ...
                              <div class="info-right-about">
                                 <div class="info-right-community">
                                    ...
                                    <div class="community-img">
                                       <!-- LINE-QRcode按鈕 -->
                                       <button type="button" class="community-line qrcode-open" onclick="openwindow()"><img src="{{asset('/img/header/line.svg')}}" alt="屏東-恆春民宿-森五七行館-line"></button>
                                       <a href="https://www.instagram.com/shen57hostel/" target="_blank"><img src="{{asset('/img/header/instagram.svg')}}" alt="屏東-恆春民宿-森五七行館-instagram"></a>
                                       <a href="https://www.facebook.com/shen57hostel2016" target="_blank"><img src="{{asset('/img/header/facebook.svg')}}" alt="屏東-恆春民宿-森五七行館-facebook"></a>
                                    </div>
                                 </div>
                                 ...
                                 <div class="hambox-shen-text">
                                    ...
                                    <div class="hambox-shen-text-bottom">
                                       ...
                                       <div>
                                          ...
                                          <img src="{{asset('/img/booking/room5-arrow-black.svg')}}" alt="屏東-恆春民宿-前往森五時尚館" class="bottom-img-left" hidden>
                                       </div>
                                    </div>
                                 </div>
                              </a>
                              <a href="room7" class="hambox-rooms-shen7">
                                 <div class="hambox-shen-text">
                                    ...
                                    <div class="hambox-shen-text-bottom">
                                       ...
                                       <img src="{{asset('/img/booking/room7-arrow-black.svg')}}" alt="屏東-恆春民宿-前往森七和風館" class="bottom-img-right" hidden>
                                    </div>
                                 </div>
                              </a>
                           </div>
