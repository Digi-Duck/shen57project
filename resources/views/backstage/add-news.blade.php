    ...
    <main class="add-news">
        ...
        <section class="add-input-box">
            <form action="/admin/addnews" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="add-title">
                    <label for="date">時間<span class="memo-span">(必填)</span></label><input type="text" name="date" id="date"
                ...
                <div class="add-content">
                    <label for="main-news-content">內容<span class="memo-span">(必填)可輸入任意行數</span></label>
